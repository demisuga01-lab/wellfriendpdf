#!/usr/bin/env python3
"""Prompt 29 coverage report runner.
...
def main() -> int:
    ...
    support = {
        "schema_version": "prompt29.coverage-tool-support-matrix.v1",
    ...
    if cargo_llvm_cov:
        ...
        verdict = "passed" if result["status"] == "passed" else "failed"
    low_risks = [
        {"area": "malformed font and CMap edge cases", "risk": "requires larger hostile-font corpus", "owner": "prompt30_or_continuous_fuzz"},
        {"area": "renderer shading/transparency long tail", "risk": "fuzz coverage does not prove visual equivalence", "owner": "prompt30_differential_visual"},
        {"area": "signature trust unusual evidence", "risk": "requires external PKI/certificate corpus", "owner": "prompt30_security_audit"},
    ...
    write_json(
        ...
        {
            "schema_version": "prompt29.coverage-summary.v1",
            "generated_at_utc": utc(),
            "status": status,
            "result": result,
    ...
    write_json(
        ...
        {
            "schema_version": "prompt29.coverage-low-risk-register.v1",
            "generated_at_utc": utc(),
            "risks": low_risks,
            "verdict": "passed",
        },
