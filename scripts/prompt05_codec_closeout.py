#!/usr/bin/env python3
"""Generate Prompt 05 codec scheduler/corpus/fuzz close-out artifacts."""
...
CALLSITES: list[dict[str, Any]] = [
    {
        ...
        "artifact": "target/prompt05-codec-closeout/codec-coverage-matrix.json",
    ...
    },
    {
        ...
        "status": "scheduler_covered",
        "artifact": "target/prompt05-codec-closeout/hostile-corpus-run.json",
    ...
    },
    {
        ...
        "status": "scheduler_covered",
        "artifact": "target/prompt05-codec-closeout/decode-callsite-inventory.json",
    ...
    },
    {
        ...
        "decode_behavior": "renderer soft mask path covered by Prompt 04 scheduler",
        "status": "already_covered",
        "artifact": "target/prompt04-codec-boundary-scheduler/renderer-scheduler-report.json",
        "test_or_smoke": "renderer Prompt 04 scheduler tests",
    },
    {
        "id": "stencil_mask_decoding",
        "module": "crates/engine/src/render/page_renderer.rs",
        "entry_points": ["scheduled_decode_image"],
        "decode_behavior": "renderer stencil/image-mask path covered by Prompt 04 scheduler",
        "status": "already_covered",
        "artifact": "target/prompt04-codec-boundary-scheduler/renderer-scheduler-report.json",
        "test_or_smoke": "renderer Prompt 04 scheduler tests",
    },
    ...
    },
    {
        ...
        "decode_behavior": "OCR preparation renders a page image; renderer decode scheduler from Prompt 04 applies",
        "status": "already_covered",
        "artifact": "target/prompt04-codec-boundary-scheduler/renderer-scheduler-report.json",
        "test_or_smoke": "Prompt 04 renderer scheduler tests",
    ...
    },
    {
        ...
        "artifact": "target/prompt04-codec-boundary-scheduler/native-codec-boundary-report.json",
...
def build_performance(hostile: dict[str, Any] | None, fuzz: dict[str, Any] | None) -> dict[str, Any]:
    ...
    return {
        ...
        "worker_overhead_benchmark": {
            "status": "not_remeasured_in_prompt05",
            "basis": "Prompt 03 release gate remains authoritative for subprocess worker overhead",
        },
    }
...
def build_verdict(
    ...
    return {
        "schema_version": 1,
        "prompt": "combined_prompt05",
        "status": "go_for_prompt06" if go else "partial",
        ...
        "worker_timeout_output_cap_evidence": {
            "worker_policy": "Prompt 03 codec isolation worker timeout/output caps retained",
            "prompt04_native_boundary": "target/prompt04-codec-boundary-scheduler/native-codec-boundary-report.json",
        },
        "memory_performance_metrics": str(PERFORMANCE.as_posix()),
        "known_limits": [
            "Prompt 05 smoke proves harnesses and bounded hostile corpus behavior; multi-day libFuzzer campaigns remain release hardening work.",
        ...
        "next_prompt_readiness": "Combined Prompt 06 can begin" if go else "Combined Prompt 06 should wait",
    }
...
def main() -> int:
    ...
    return 0 if verdict["status"] == "go_for_prompt06" else 1
