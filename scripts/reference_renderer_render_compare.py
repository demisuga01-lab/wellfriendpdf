#!/usr/bin/env python3
"""Run the Native Renderer corpus through Wellfriend, Poppler, PDFium, and MuPDF."""
...
RENDER_DIR = OUT_DIR / "reference_renderer-renders"
DIFF_DIR = OUT_DIR / "reference_renderer-diffs"
LOG_DIR = OUT_DIR / "reference_renderer-logs"
WELLFRIENDPDF_REPORT_DIR = OUT_DIR / "reference_renderer-wellfriendpdf-reports"

TOOL_MANIFEST = OUT_DIR / "reference-tool-manifest-reference_renderer.json"
CORPUS_MANIFEST = OUT_DIR / "multi-reference-corpus-manifest-reference_renderer.json"
RENDER_RESULTS = OUT_DIR / "multi-reference-render-results-reference_renderer.json"
DIFF_METRICS = OUT_DIR / "multi-reference-diff-metrics-reference_renderer.json"
DISAGREEMENT_SUMMARY = OUT_DIR / "reference-disagreement-summary-reference_renderer.json"
TAXONOMY = OUT_DIR / "renderer-parity-taxonomy-reference_renderer.json"
HTML_REPORT = OUT_DIR / "reference_renderer-html-report" / "index.html"
...
def native_renderer_module() -> Any:
    script = Path("scripts/native_renderer_renderer_parity_audit.py")
    spec = importlib.util.spec_from_file_location("native_renderer_renderer_parity_audit", script)
...
def render_html(results: dict[str, Any], summary: dict[str, Any]) -> None:
    ...
    HTML_REPORT.write_text(
        ...
        "<title>Reference Renderer Multi-Reference Renderer Audit</title>"
        ...
        "<h1>Reference Renderer Multi-Reference Renderer Audit</h1>"
...
def main() -> int:
    ...
    write_json(
        ...
        {
            "schema_version": 1,
            "kind": "reference_renderer_multi_reference_corpus_manifest",
            "page_count": len(available_corpus),
            "categories": categories,
            "added_reference_renderer_fixtures": [],
    ...
    summary = {
        "schema_version": 1,
        "kind": "reference_renderer_reference_disagreement_summary",
        "page_count": len(available_corpus),
    ...
    results = {
        "schema_version": 1,
        "kind": "reference_renderer_multi_reference_render_results",
        "dpi": args.dpi,
        "page_count": len(available_corpus),
        "categories": categories,
    ...
    taxonomy = {
        "schema_version": 1,
        "kind": "reference_renderer_renderer_parity_taxonomy",
    ...
    write_json(DIFF_METRICS, {"schema_version": 1, "kind": "reference_renderer_multi_reference_diff_metrics", "pages": metrics_pages})
