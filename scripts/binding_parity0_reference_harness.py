#!/usr/bin/env python3
"""Execute advanced editing CLI mutations and multi-renderer reference proof."""
...
SCHEMA = "advanced_editing.reference-execution.v1"
...
def main() -> int:
    ...
    fixture = corpus / "advanced_editing-text-vector-ink.pdf"
    ...
    pdfium_candidate = repo / "target" / "reference_renderer-tools" / "pdfium" / "pdfium_test.cmd"
    mupdf_candidate = repo / "target" / "reference_renderer-tools" / "mupdf" / "mutool.exe"
    tools = {
        "poppler": poppler,
    ...
    destination = output / "advanced_editing-reference-execution.json"
