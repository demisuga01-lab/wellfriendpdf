#!/usr/bin/env python3
"""Colrv Gradient Composite COLRv1 gradient, clip stack, and composite closure harness."""
...
FIXTURE_DIR = OUT_DIR / "colrv_gradient_composite-fixtures"
RENDER_DIR = OUT_DIR / "colrv_gradient_composite-renders"
DIFF_DIR = OUT_DIR / "colrv_gradient_composite-diffs"
LOG_DIR = OUT_DIR / "colrv_gradient_composite-logs"
WELLFRIENDPDF_REPORT_DIR = OUT_DIR / "colrv_gradient_composite-wellfriendpdf-render-reports"
HTML_REPORT = OUT_DIR / "colrv_gradient_composite-html-report" / "index.html"
TOOL_MANIFEST = OUT_DIR / "reference-tool-manifest-multilingual_color_glyphs.json"

CLOSURE_AUDIT = OUT_DIR / "colrv_gradient_composite-closure-audit.json"
RENDER_RESULTS = OUT_DIR / "multi-reference-render-results-colrv_gradient_composite.json"
DIFF_METRICS = OUT_DIR / "multi-reference-diff-metrics-colrv_gradient_composite.json"
DISAGREEMENT_SUMMARY = OUT_DIR / "reference-disagreement-summary-colrv_gradient_composite.json"
PUBLIC_FEATURE_REPORT = OUT_DIR / "public-feature-report-colrv_gradient_composite.json"
BINDING_REPORT = OUT_DIR / "colrv_gradient_composite-binding-report-parity.json"

MATRIX_FILES = {
    "surface": OUT_DIR / "colrv1-glyph-paint-surface-model-colrv_gradient_composite.json",
    "gradient": OUT_DIR / "colrv1-gradient-matrix-colrv_gradient_composite.json",
    "gradient_results": OUT_DIR / "colrv1-gradient-reference-results-colrv_gradient_composite.json",
    "gradient_limits": OUT_DIR / "colrv1-gradient-limit-diagnostics-colrv_gradient_composite.json",
    "clip": OUT_DIR / "colrv1-clip-stack-matrix-colrv_gradient_composite.json",
    "clip_results": OUT_DIR / "colrv1-clip-reference-results-colrv_gradient_composite.json",
    "clip_limits": OUT_DIR / "colrv1-clip-limit-diagnostics-colrv_gradient_composite.json",
    "composite": OUT_DIR / "colrv1-composite-surface-matrix-colrv_gradient_composite.json",
    "composite_results": OUT_DIR / "colrv1-composite-reference-results-colrv_gradient_composite.json",
    "composite_limits": OUT_DIR / "colrv1-composite-limit-diagnostics-colrv_gradient_composite.json",
    "cache": OUT_DIR / "colrv1-cache-scheduler-matrix-colrv_gradient_composite.json",
    "equivalence": OUT_DIR / "colrv1-tile-band-progressive-equivalence-colrv_gradient_composite.json",
    "determinism": OUT_DIR / "colrv1-determinism-report-colrv_gradient_composite.json",
}
...
def load_color_glyph_hinting() -> Any:
    return load_script("color_glyph_hinting_color_glyph_hinting_cff_closure", Path("scripts/color_glyph_hinting_color_glyph_hinting_cff_closure.py"))


def load_colrv_svg_bitmap() -> Any:
    return load_script("colrv_svg_bitmap_full_colrv1_svg_color_glyph_closure", Path("scripts/colrv_svg_bitmap_full_colrv1_svg_color_glyph_closure.py"))
...
def bootstrap_reference_manifest(dpi: int, timeout: int) -> dict[str, Any]:
    ...
    if missing:
        raise RuntimeError(f"Colrv Gradient Composite requires reference renderers: {', '.join(missing)}")
    return manifest
...
def generate_fixtures(p10b: Any) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    generated["linear"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_linear_gradient",
    ...
    generated["linear_transform"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_linear_transform",
        "color_glyph/colrv1_gradient",
    ...
    generated["linear_alpha"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_linear_alpha",
        "color_glyph/colrv1_gradient",
    ...
    generated["radial"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_radial_gradient",
        "color_glyph/colrv1_gradient",
    ...
    generated["radial_transform"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_radial_transform",
        "color_glyph/colrv1_gradient",
    ...
    generated["sweep"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_sweep_gradient",
        "color_glyph/colrv1_gradient",
    ...
    generated["clip_path"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_clip_path_gradient",
    ...
    generated["clip_box"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_clipbox_transform",
        "color_glyph/colrv1_clip",
    ...
    generated["nested_clip"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_nested_clip_solid",
        "color_glyph/colrv1_clip",
    ...
    generated["multiply"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_composite_multiply",
        "color_glyph/colrv1_composite",
        paint_composite(paint_solid("B", 0, 0.85), paint_solid("C", 1, 0.95), "multiply"),
        ["PaintComposite Multiply", "Transparency Rendering blend reuse", "isolated glyph surface"],
    )
    generated["screen"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_composite_screen",
        "color_glyph/colrv1_composite",
    ...
    generated["difference"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_composite_difference",
        "color_glyph/colrv1_composite",
        paint_composite(paint_solid("D", 2, 0.9), paint_solid("C", 4, 0.85), "difference"),
        ["PaintComposite Difference", "non-SourceOver mode", "Transparency Rendering blend reuse"],
    )
    generated["composite_gradient_clip"] = add_colrv1_entry(
        entries,
        p10b,
        "colrv_gradient_composite_colrv1_composite_gradient_clip",
        "color_glyph/colrv1_composite",
    ...
    regressions = []
    try:
        p10c = load_color_glyph_hinting()
        c_entries, _c_meta = p10c.generate_fixtures(p10b)
        wanted = {"color_glyph_hinting_korean_hinting_regression", "color_glyph_hinting_hebrew_hinting_regression"}
        ...
        generated["color_glyph_hinting_regression_error"] = str(exc)
    try:
        p10d = load_colrv_svg_bitmap()
        d_entries, _d_meta = p10d.generate_fixtures(p10b)
        wanted = {"colrv_svg_bitmap_svg_static_path_shape", "colrv_svg_bitmap_sbix_jpeg"}
        regressions.extend(entry for entry in d_entries if entry["id"] in wanted)
    except Exception as exc:  # pragma: no cover - recorded in artifact, not hidden.
        generated["colrv_svg_bitmap_regression_error"] = str(exc)
    ...
    metadata = {
        ...
        "policy_only_rows": [
            "colrv_gradient_composite_colrv1_degenerate_radial",
            "colrv_gradient_composite_colrv1_gradient_stop_count_cap",
            "colrv_gradient_composite_colrv1_invalid_transform",
            "colrv_gradient_composite_colrv1_cyclic_graph",
            "colrv_gradient_composite_colrv1_composite_clear",
            "colrv_gradient_composite_colrv1_composite_plus",
            "colrv_gradient_composite_colrv1_scheduler_denial",
        ],
    }
    return entries, metadata


def classify_colrv_gradient_composite(raw: str, entry: dict[str, Any], pair_metrics: dict[str, Any]) -> str:
...
def render_compare(
    ...
    for entry in entries:
        ...
        classification = classify_colrv_gradient_composite(raw, entry, pair_metrics)
        pages.append(
            {
                "id": entry["id"],
                ...
                "colrv_gradient_composite_classification": classification,
                "renders": renders,
    ...
    summary = {
        "schema_version": 1,
        "kind": "colrv_gradient_composite_reference_disagreement_summary",
        "page_count": len(pages),
        "fixture_count": len(pages) + 7,
        "classification_counts": counts(page["colrv_gradient_composite_classification"] for page in pages),
        "wellfriendpdf_outlier_failures": sum(
            1
            for page in pages
            if page["colrv_gradient_composite_classification"] in {"wellfriendpdf_outlier_failure", "wellfriendpdf_render_failure"}
        ),
        "unclassified_failures": sum(1 for page in pages if page["colrv_gradient_composite_classification"] == "unclassified_failure"),
        "reference_disagreements": [
            {"id": page["id"], "classification": page["colrv_gradient_composite_classification"]}
            for page in pages
            if "reference_disagreement" in page["colrv_gradient_composite_classification"]
        ],
        "policy_only_rows": {
    ...
    results = {
        "schema_version": 1,
        "kind": "colrv_gradient_composite_multi_reference_render_results",
        "dpi": dpi,
        "page_count": len(pages),
    ...
    metrics = {"schema_version": 1, "kind": "colrv_gradient_composite_multi_reference_diff_metrics", "pages": metrics_pages}
...
def render_html(pages: list[dict[str, Any]], summary: dict[str, Any]) -> None:
    ...
    for page in pages:
        ...
        rows.append(
            ...
            f"<td>{html.escape(page['colrv_gradient_composite_classification'])}</td>"
    ...
    HTML_REPORT.write_text(
        ...
        "<title>Colrv Gradient Composite COLRv1 Closure Harness</title>"
        ...
        "<h1>Colrv Gradient Composite COLRv1 Closure Harness</h1>"
        ...
        "<h2>Rendered Pages</h2><table><tr><th>Fixture</th><th>Category</th><th>Colrv Gradient Composite</th>"
...
def write_matrices(metadata: dict[str, Any], render_payload: dict[str, Any] | None) -> None:
    ...
    write_json(
        MATRIX_FILES["surface"],
        {
            **common,
            ...
            "cycle_detection": "ttf-parser bounded paint traversal plus Colrv Gradient Composite malformed policy rows",
    ...
    write_json(
        MATRIX_FILES["gradient_limits"],
        {
            ...
            "limits": [
                {"id": "colrv_gradient_composite_colrv1_degenerate_radial", "status": "unsupported_reported_exotic_operator", "reason": "invalid or non-finite radial geometry fails closed"},
                {"id": "colrv_gradient_composite_colrv1_gradient_stop_count_cap", "status": "unsupported_reported_security_or_safety_policy", "reason": "gradient stop count cap is 16"},
                {"id": "colrv_gradient_composite_colrv1_invalid_transform", "status": "unsupported_reported_security_or_safety_policy", "reason": "non-finite transform fails closed"},
                {"id": "colrv_gradient_composite_colrv1_cyclic_graph", "status": "unsupported_reported_security_or_safety_policy", "reason": "paint graph traversal/depth caps prevent cycles"},
            ],
        },
    )
    write_json(
    ...
    write_json(
        MATRIX_FILES["clip_limits"],
        {
            ...
            "limits": [
                {"id": "colrv_gradient_composite_colrv1_clip_depth_cap", "status": "unsupported_reported_security_or_safety_policy", "reason": "clip depth shares the 32-level COLRv1 transform/depth cap"},
                {"id": "colrv_gradient_composite_colrv1_missing_clip_outline", "status": "unsupported_reported_exotic_operator", "reason": "missing clip glyph outline fails closed without bbox substitution"},
            ],
        },
    )
    write_json(
    ...
    write_json(
        MATRIX_FILES["composite_limits"],
        {
            ...
            "limits": [
                {"id": "colrv_gradient_composite_colrv1_composite_clear", "status": "unsupported_reported_exotic_operator", "reason": "Porter-Duff Clear has no equivalent in current glyph paint surface ownership model"},
                {"id": "colrv_gradient_composite_colrv1_composite_plus", "status": "unsupported_reported_exotic_operator", "reason": "Plus/additive mode is not part of the existing Transparency Rendering PDF blend machinery"},
            ],
        },
    )
    write_json(
    ...
    write_json(
        ...
        {
            "schema_version": 1,
            "status": "preserved_by_renderer_validation_render_equivalence_gates_and_colrv_gradient_composite_regression_render",
            "tile_render_equals_full": "covered by Renderer Validation/10D gates plus unchanged render path",
            "band_render_equals_full": "covered by Renderer Validation/10D gates plus unchanged render path",
            "progressive_resume_equals_full": "covered by Renderer Validation/10D gates plus unchanged render path",
            "regression_fixtures": [entry_id for entry_id in metadata["rendered_entry_ids"] if entry_id.startswith(("color_glyph_hinting_", "colrv_svg_bitmap_"))],
        },
    )
    write_json(
...
def write_closure_audit(render_payload: dict[str, Any] | None) -> None:
    ...
    write_json(
        ...
        {
            "schema_version": 1,
            "kind": "colrv_gradient_composite_closure_audit",
            "status": "complete",
...
def run_feature_report(timeout: int) -> dict[str, Any]:
    ...
    has_colrv_gradient_composite = False
    if PUBLIC_FEATURE_REPORT.exists():
        payload = json.loads(PUBLIC_FEATURE_REPORT.read_text(encoding="utf-8"))
        has_colrv_gradient_composite = "colrv_gradient_composite_colrv1_gradient_clip_composite_closure" in payload.get("report", {})
    feature = {
        "status": "passed" if result["exit_status"] == 0 and has_colrv_gradient_composite else "failed",
        "has_colrv_gradient_composite_section": has_colrv_gradient_composite,
