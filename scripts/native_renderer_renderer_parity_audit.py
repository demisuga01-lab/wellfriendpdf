#!/usr/bin/env python3
"""Generate Native Renderer renderer parity and native replay audit artifacts."""
        ...
        out.append(
            {
                ...
                "page": 1,
                "available": p.exists(),
                "role": "native_renderer_parity_corpus",
            }
        )
    return out
...
def main() -> int:
        ...
        baseline_pages.append(
            {
                ...
                "status": "simulated_decode_scheduler_pre_native_replay",
                "compatibility_runs": 1 if baseline_fallback else 0,
                "native_text_ops": 0,
                "native_image_xobjects": 0,
                "native_inline_images": 0,
                "native_form_xobjects": 0,
                "fallback_reason": "decode_scheduler_high_level_page_content" if baseline_fallback else None,
            }
        )
    ...
    baseline = {
        "schema_version": 1,
        "kind": "native_renderer_parity_baseline",
        "starting_commit": run_command(["git", "rev-parse", "--short", "HEAD"], timeout=10),
        "note": "Baseline models the Decode Scheduler high-level display-list posture before native text/image/form operations were introduced.",
    ...
    after = {
        "schema_version": 1,
        "kind": "native_renderer_parity_after_native_replay",
        "corpus_size": len(corpus),
        "categories": categories,
    ...
    counters = {
        "schema_version": 1,
        "kind": "native_renderer_native_replay_counters",
    ...
    visual = {
        "schema_version": 1,
        "kind": "native_renderer_visual_diff_summary",
    ...
    REPORT_HTML.write_text(
        "<!doctype html><meta charset='utf-8'><title>Native Renderer Renderer Parity</title>"
        ...
        "<h1>Native Renderer Renderer Parity Audit</h1>"
