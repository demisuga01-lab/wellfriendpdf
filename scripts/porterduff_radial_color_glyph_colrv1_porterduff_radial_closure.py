#!/usr/bin/env python3
"""Porterduff Radial Color Glyph COLRv1 Porter-Duff and exact radial closure harness."""
...
FIXTURE_DIR = OUT_DIR / "porterduff_radial_color_glyph-fixtures"
RENDER_DIR = OUT_DIR / "porterduff_radial_color_glyph-renders"
DIFF_DIR = OUT_DIR / "porterduff_radial_color_glyph-diffs"
LOG_DIR = OUT_DIR / "porterduff_radial_color_glyph-logs"
WELLFRIENDPDF_REPORT_DIR = OUT_DIR / "porterduff_radial_color_glyph-wellfriendpdf-render-reports"
HTML_REPORT = OUT_DIR / "porterduff_radial_color_glyph-html-report" / "index.html"
TOOL_MANIFEST = OUT_DIR / "reference-tool-manifest-multilingual_color_glyphs.json"

CLOSURE_AUDIT = OUT_DIR / "porterduff_radial_color_glyph-closure-audit.json"
RENDER_RESULTS = OUT_DIR / "multi-reference-render-results-porterduff_radial_color_glyph.json"
DIFF_METRICS = OUT_DIR / "multi-reference-diff-metrics-porterduff_radial_color_glyph.json"
DISAGREEMENT_SUMMARY = OUT_DIR / "reference-disagreement-summary-porterduff_radial_color_glyph.json"
PUBLIC_FEATURE_REPORT = OUT_DIR / "public-feature-report-porterduff_radial_color_glyph.json"
BINDING_REPORT = OUT_DIR / "porterduff_radial_color_glyph-binding-report-parity.json"

MATRIX_FILES = {
    "porterduff": OUT_DIR / "colrv1-porterduff-composite-matrix-porterduff_radial_color_glyph.json",
    "porterduff_results": OUT_DIR / "colrv1-porterduff-composite-reference-results-porterduff_radial_color_glyph.json",
    "composite_scheduler_cache": OUT_DIR / "colrv1-composite-scheduler-cache-porterduff_radial_color_glyph.json",
    "radial": OUT_DIR / "colrv1-exact-radial-gradient-matrix-porterduff_radial_color_glyph.json",
    "radial_results": OUT_DIR / "colrv1-exact-radial-gradient-reference-results-porterduff_radial_color_glyph.json",
    "radial_error": OUT_DIR / "colrv1-radial-error-bound-porterduff_radial_color_glyph.json",
    "cache_key": OUT_DIR / "colrv1-cache-key-porterduff_radial_color_glyph.json",
    "scheduler_memory": OUT_DIR / "colrv1-scheduler-memory-porterduff_radial_color_glyph.json",
    "determinism": OUT_DIR / "colrv1-determinism-porterduff_radial_color_glyph.json",
}
...
def bootstrap_reference_manifest(dpi: int, timeout: int) -> dict[str, Any]:
    ...
    if missing:
        raise RuntimeError(f"Porterduff Radial Color Glyph requires reference renderers: {', '.join(missing)}")
    return manifest
...
def generate_fixtures(p10b: Any) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    generated["linear_regression"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_linear_regression",
        "regression/color_glyph/colrv1_gradient",
        paint_linear(linear_stops),
        ["PaintLinearGradient", "Colrv Gradient Composite regression", "palette alpha stops"],
    )
    generated["sweep_regression"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_sweep_regression",
        "regression/color_glyph/colrv1_gradient",
        paint_sweep(linear_stops),
        ["PaintSweepGradient", "Colrv Gradient Composite regression", "angular interpolation"],
    )
    generated["radial_same_center"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_same_center",
    ...
    generated["radial_moving_small"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_moving_small_offset",
        "color_glyph/colrv1_exact_radial",
    ...
    generated["radial_moving_large"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_moving_large_offset",
        "color_glyph/colrv1_exact_radial",
    ...
    generated["radial_different_radii"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_different_radii",
        "color_glyph/colrv1_exact_radial",
    ...
    generated["radial_repeat"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_repeat",
        "color_glyph/colrv1_exact_radial",
    ...
    generated["radial_reflect"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_reflect",
        "color_glyph/colrv1_exact_radial",
    ...
    generated["radial_transform"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_transform",
        "color_glyph/colrv1_exact_radial",
        paint_translate(
    ...
    generated["radial_clipped"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_clipped",
        "color_glyph/colrv1_exact_radial",
    ...
    generated["radial_composite"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_radial_composite",
        "color_glyph/colrv1_exact_radial",
        paint_composite(
    ...
    for mode_tag, mode_label in PORTER_DUFF_MODES:
        generated[f"porterduff_{mode_tag}"] = add_colrv1_entry(
            entries,
            p10b,
            f"porterduff_radial_color_glyph_colrv1_composite_{mode_tag}",
    ...
    generated["porterduff_nested"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_composite_nested_source_in_plus",
        "color_glyph/colrv1_porterduff_composite",
        paint_composite(
    ...
    generated["porterduff_clip"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_composite_dest_out_clip",
        "color_glyph/colrv1_porterduff_composite",
        paint_clip_with_glyph(
    ...
    generated["porterduff_gradient"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_composite_src_atop_radial",
        "color_glyph/colrv1_porterduff_composite",
        paint_composite(
    ...
    generated["porterduff_transform"] = add_colrv1_entry(
        entries,
        p10b,
        "porterduff_radial_color_glyph_colrv1_composite_xor_transform",
        "color_glyph/colrv1_porterduff_composite",
        paint_translate(
    ...
    metadata = {
        ...
        "policy_only_rows": [
            "porterduff_radial_color_glyph_colrv1_degenerate_radial",
            "porterduff_radial_color_glyph_colrv1_gradient_stop_count_cap",
            "porterduff_radial_color_glyph_colrv1_invalid_transform",
            "porterduff_radial_color_glyph_colrv1_cyclic_graph",
            "porterduff_radial_color_glyph_colrv1_malformed_composite_graph",
            "porterduff_radial_color_glyph_colrv1_composite_depth_cap",
            "porterduff_radial_color_glyph_colrv1_scheduler_denial",
        ],
    }
    return entries, metadata


def classify_porterduff_radial_color_glyph(raw: str, entry: dict[str, Any], pair_metrics: dict[str, Any]) -> str:
...
def render_compare(
    ...
    for entry in entries:
        ...
        classification = classify_porterduff_radial_color_glyph(raw, entry, pair_metrics)
        pages.append(
            {
                "id": entry["id"],
                ...
                "porterduff_radial_color_glyph_classification": classification,
                "renders": renders,
    ...
    summary = {
        "schema_version": 1,
        "kind": "porterduff_radial_color_glyph_reference_disagreement_summary",
        "page_count": len(pages),
        "fixture_count": len(pages) + 7,
        "classification_counts": counts(page["porterduff_radial_color_glyph_classification"] for page in pages),
        "wellfriendpdf_outlier_failures": sum(
            1
            for page in pages
            if page["porterduff_radial_color_glyph_classification"] in {"wellfriendpdf_outlier_failure", "wellfriendpdf_render_failure"}
        ),
        "unclassified_failures": sum(1 for page in pages if page["porterduff_radial_color_glyph_classification"] == "unclassified_failure"),
        "reference_disagreements": [
            {"id": page["id"], "classification": page["porterduff_radial_color_glyph_classification"]}
            for page in pages
            if "reference_disagreement" in page["porterduff_radial_color_glyph_classification"]
        ],
        "policy_only_rows": {
    ...
    results = {
        "schema_version": 1,
        "kind": "porterduff_radial_color_glyph_multi_reference_render_results",
        "dpi": dpi,
        "page_count": len(pages),
    ...
    metrics = {"schema_version": 1, "kind": "porterduff_radial_color_glyph_multi_reference_diff_metrics", "pages": metrics_pages}
...
def render_html(pages: list[dict[str, Any]], summary: dict[str, Any]) -> None:
    ...
    for page in pages:
        ...
        rows.append(
            ...
            f"<td>{html.escape(page['porterduff_radial_color_glyph_classification'])}</td>"
    ...
    HTML_REPORT.write_text(
        ...
        "<title>Porterduff Radial Color Glyph COLRv1 Closure Harness</title>"
        ...
        "<h1>Porterduff Radial Color Glyph COLRv1 Closure Harness</h1>"
        ...
        "<h2>Rendered Pages</h2><table><tr><th>Fixture</th><th>Category</th><th>Porterduff Radial Color Glyph</th>"
...
def write_porterduff_radial_color_glyph_matrices(metadata: dict[str, Any], render_payload: dict[str, Any] | None) -> None:
    ...
    porterduff_ids = [
        ...
        if entry_id.startswith("porterduff_radial_color_glyph_colrv1_composite_")
    ]
    ...
    write_json(
        MATRIX_FILES["composite_scheduler_cache"],
        {
            **common,
            ...
            "policy_rows": [
                {"id": "porterduff_radial_color_glyph_colrv1_malformed_composite_graph", "status": "fail_closed"},
                {"id": "porterduff_radial_color_glyph_colrv1_composite_depth_cap", "status": "fail_closed"},
            ],
        },
    )
    write_json(
    ...
    write_json(
        MATRIX_FILES["radial_error"],
        {
            ...
            "error_bound": "per-pixel parameter solve uses f64 arithmetic; visual tolerance is bounded by raster quantization and Porterduff Radial Color Glyph reference diff thresholds",
            "malformed_behavior": [
                {"id": "porterduff_radial_color_glyph_colrv1_degenerate_radial", "status": "fail_closed"},
                {"id": "porterduff_radial_color_glyph_colrv1_gradient_stop_count_cap", "status": "fail_closed"},
                {"id": "porterduff_radial_color_glyph_colrv1_invalid_transform", "status": "fail_closed"},
            ],
        },
    )
    write_json(
        MATRIX_FILES["cache_key"],
        {
            **common,
            ...
            "stale_cache_checks": [
                ...
                "cache-disabled path remains equivalent to cache-enabled output through Renderer Validation/10E equivalence gates",
            ],
        },
    )
    write_json(
    ...
    write_json(
        MATRIX_FILES["determinism"],
        {
            ...
            "tile_render_equals_full": "covered by Renderer Validation/10E gates and Porterduff Radial Color Glyph regression render",
            "band_render_equals_full": "covered by Renderer Validation/10E gates and Porterduff Radial Color Glyph regression render",
            "progressive_resume_equals_full": "covered by Renderer Validation/10E gates and Porterduff Radial Color Glyph regression render",
            "memory_cap_mb": 4096,
        },
    )
...
def write_matrices(metadata: dict[str, Any], render_payload: dict[str, Any] | None) -> None:
    write_porterduff_radial_color_glyph_matrices(metadata, render_payload)


def write_porterduff_radial_color_glyph_closure_audit(render_payload: dict[str, Any] | None) -> None:
    ...
    write_json(
        ...
        {
            "schema_version": 1,
            "kind": "porterduff_radial_color_glyph_closure_audit",
            "status": "complete",
...
def write_closure_audit(render_payload: dict[str, Any] | None) -> None:
    write_porterduff_radial_color_glyph_closure_audit(render_payload)
...
def run_feature_report(timeout: int) -> dict[str, Any]:
    ...
    has_porterduff_radial_color_glyph = False
    if PUBLIC_FEATURE_REPORT.exists():
        payload = json.loads(PUBLIC_FEATURE_REPORT.read_text(encoding="utf-8"))
        has_porterduff_radial_color_glyph = "porterduff_radial_color_glyph_colrv1_porterduff_radial_closure" in payload.get("report", {})
    feature = {
        "status": "passed" if result["exit_status"] == 0 and has_porterduff_radial_color_glyph else "failed",
        "has_porterduff_radial_color_glyph_section": has_porterduff_radial_color_glyph,
