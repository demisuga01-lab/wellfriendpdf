...
def focused_gate_evidence() -> list[dict[str, Any]]:
    ...
    commands = {
        ...
        "20260721-020550-command-run-default.samples.csv": "cargo test -p wellfriendpdf-engine --test prompt18b_advanced_secure_mutation prompt25_signature_preserving_form_fill --jobs 1",
