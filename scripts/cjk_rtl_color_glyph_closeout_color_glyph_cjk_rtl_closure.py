#!/usr/bin/env python3
"""CJK RTL Color Glyph Closeout color glyph and CJK/RTL closure harness."""
...
FIXTURE_DIR = OUT_DIR / "cjk_rtl_color_glyph_closeout-fixtures"
RENDER_DIR = OUT_DIR / "cjk_rtl_color_glyph_closeout-renders"
DIFF_DIR = OUT_DIR / "cjk_rtl_color_glyph_closeout-diffs"
LOG_DIR = OUT_DIR / "cjk_rtl_color_glyph_closeout-logs"
WELLFRIENDPDF_REPORT_DIR = OUT_DIR / "cjk_rtl_color_glyph_closeout-wellfriendpdf-render-reports"
HTML_REPORT = OUT_DIR / "cjk_rtl_color_glyph_closeout-html-report" / "index.html"

TOOL_MANIFEST = OUT_DIR / "reference-tool-manifest-multilingual_color_glyphs.json"
CLOSURE_AUDIT = OUT_DIR / "cjk_rtl_color_glyph_closeout-closure-audit.json"
RENDER_RESULTS = OUT_DIR / "cjk_rtl_color_glyph_closeout-multi-reference-render-results.json"
DIFF_METRICS = OUT_DIR / "cjk_rtl_color_glyph_closeout-multi-reference-diff-metrics.json"
DISAGREEMENT_SUMMARY = OUT_DIR / "cjk_rtl_color_glyph_closeout-reference-disagreement-summary.json"
PUBLIC_FEATURE_REPORT = OUT_DIR / "public-feature-report-cjk_rtl_color_glyph_closeout.json"

MATRIX_FILES = {
    "colr": OUT_DIR / "color-glyph-colr-cpal-matrix-cjk_rtl_color_glyph_closeout.json",
    "colr_results": OUT_DIR / "color-glyph-colr-cpal-reference-results-cjk_rtl_color_glyph_closeout.json",
    "cbdt": OUT_DIR / "color-glyph-cbdt-cblc-matrix-cjk_rtl_color_glyph_closeout.json",
    "cbdt_results": OUT_DIR / "color-glyph-cbdt-cblc-reference-results-cjk_rtl_color_glyph_closeout.json",
    "sbix": OUT_DIR / "color-glyph-sbix-matrix-cjk_rtl_color_glyph_closeout.json",
    "sbix_results": OUT_DIR / "color-glyph-sbix-reference-results-cjk_rtl_color_glyph_closeout.json",
    "svg": OUT_DIR / "color-glyph-svg-opentype-policy-cjk_rtl_color_glyph_closeout.json",
    "svg_security": OUT_DIR / "color-glyph-security-block-report-cjk_rtl_color_glyph_closeout.json",
    "korean": OUT_DIR / "korean-render-fixture-matrix-cjk_rtl_color_glyph_closeout.json",
    "korean_results": OUT_DIR / "korean-reference-results-cjk_rtl_color_glyph_closeout.json",
    "hebrew": OUT_DIR / "hebrew-render-fixture-matrix-cjk_rtl_color_glyph_closeout.json",
    "hebrew_results": OUT_DIR / "hebrew-reference-results-cjk_rtl_color_glyph_closeout.json",
    "cff": OUT_DIR / "cid-keyed-cff-clipping-matrix-cjk_rtl_color_glyph_closeout.json",
    "cff_results": OUT_DIR / "cid-keyed-cff-reference-results-cjk_rtl_color_glyph_closeout.json",
    "hinting": OUT_DIR / "hinting-posture-cjk_rtl_color_glyph_closeout.json",
}
...
def bootstrap_reference_manifest(dpi: int, timeout: int) -> dict[str, Any]:
    ...
    if missing:
        raise RuntimeError(f"CJK RTL Color Glyph Closeout requires reference renderers: {', '.join(missing)}")
    return manifest
...
def make_identity_pdf(
    ...
    *,
    ...
    objs[descriptor] = (
        b"<< /Type /FontDescriptor /FontName /CJKRTLColorGlyphCloseoutFont /Flags 4 "
    ...
    objs[cidfont] = (
        b"<< /Type /Font /Subtype /CIDFontType2 /BaseFont /CJKRTLColorGlyphCloseoutFont "
    ...
    objs[font] = (
        b"<< /Type /Font /Subtype /Type0 /BaseFont /CJKRTLColorGlyphCloseoutFont "
...
def generate_fixtures() -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    for name, path in fonts.items():
        if not path.exists():
            raise RuntimeError(f"required CJK RTL Color Glyph Closeout fixture font missing: {name} {path}")
    ...
    sbix_font, sbix_gid = make_sbix_font(fonts["latin"], FIXTURE_DIR / "cjk_rtl_color_glyph_closeout-sbix.ttf")

    colr_pdf = FIXTURE_DIR / "cjk_rtl_color_glyph_closeout-colr-cpal.pdf"
    colr_content = (
        "0 0 0 rg\n"
    ...
    korean_pdf = FIXTURE_DIR / "cjk_rtl_color_glyph_closeout-korean-hangul.pdf"
    korean_content = "".join(
    ...
    hebrew_pdf = FIXTURE_DIR / "cjk_rtl_color_glyph_closeout-hebrew-rtl.pdf"
    hebrew_content = "".join(
    ...
    sbix_pdf = FIXTURE_DIR / "cjk_rtl_color_glyph_closeout-sbix-png.pdf"
    sbix_content = (
    ...
    entries = [
        {
            "id": "cjk_rtl_color_glyph_closeout_colr_cpal_vector",
        ...
        {
            "id": "cjk_rtl_color_glyph_closeout_korean_hangul",
        ...
        {
            "id": "cjk_rtl_color_glyph_closeout_hebrew_rtl",
        ...
        {
            "id": "cjk_rtl_color_glyph_closeout_sbix_png",
    ...
    if cff_fixture.exists():
        entries.append(
            {
                "id": "cjk_rtl_color_glyph_closeout_cid_keyed_cff_clip",
...
def render_compare(entries: list[dict[str, Any]], manifest: dict[str, Any], wellfriendpdf_bin: str | None, dpi: int, timeout: int) -> dict[str, Any]:
    ...
    for entry in entries:
        ...
        cjk_rtl_color_glyph_closeout = classify_cjk_rtl_color_glyph_closeout(raw, entry, pair_metrics)
        page = {
            "id": entry["id"],
            ...
            "cjk_rtl_color_glyph_closeout_classification": cjk_rtl_color_glyph_closeout,
            "renders": renders,
    ...
    summary = {
        "schema_version": 1,
        "kind": "cjk_rtl_color_glyph_closeout_reference_disagreement_summary",
        "page_count": len(pages),
        "classification_counts": counts(page["cjk_rtl_color_glyph_closeout_classification"] for page in pages),
        "wellfriendpdf_outlier_failures": sum(
            1 for page in pages if page["cjk_rtl_color_glyph_closeout_classification"] in {"wellfriendpdf_outlier_failure", "wellfriendpdf_render_failure"}
        ),
        "unclassified_failures": sum(1 for page in pages if page["cjk_rtl_color_glyph_closeout_classification"] == "unclassified_failure"),
        "reference_disagreements": [
            {"id": page["id"], "classification": page["cjk_rtl_color_glyph_closeout_classification"]}
            for page in pages
            if "reference_disagreement" in page["cjk_rtl_color_glyph_closeout_classification"]
        ],
    }
    results = {
        "schema_version": 1,
        "kind": "cjk_rtl_color_glyph_closeout_multi_reference_render_results",
        "dpi": dpi,
        "page_count": len(pages),
        "reference_tools": manifest.get("tools", {}),
        "pages": pages,
    }
    metrics = {"schema_version": 1, "kind": "cjk_rtl_color_glyph_closeout_multi_reference_diff_metrics", "pages": metrics_pages}
...
def classify_cjk_rtl_color_glyph_closeout(raw: str, entry: dict[str, Any], pair_metrics: dict[str, Any]) -> str:
...
def render_html(pages: list[dict[str, Any]], summary: dict[str, Any]) -> None:
    ...
    for page in pages:
        ...
        rows.append(
            ...
            f"<td>{html.escape(page['cjk_rtl_color_glyph_closeout_classification'])}</td>"
    ...
    HTML_REPORT.write_text(
        ...
        "<title>CJK RTL Color Glyph Closeout Closure Harness</title>"
        ...
        "<h1>CJK RTL Color Glyph Closeout Closure Harness</h1>"
        ...
        "<h2>Pages</h2><table><tr><th>Fixture</th><th>Category</th><th>CJK RTL Color Glyph Closeout</th>"
...
def write_matrices(entries: list[dict[str, Any]], fixture_metadata: dict[str, Any], render_payload: dict[str, Any] | None) -> None:
    ...
    write_json(
        MATRIX_FILES["colr"],
        {
            **common,
            ...
            "fixtures": ["cjk_rtl_color_glyph_closeout_colr_cpal_vector"],
        },
    )
    write_json(MATRIX_FILES["colr_results"], pages.get("cjk_rtl_color_glyph_closeout_colr_cpal_vector", {}))
    write_json(
        MATRIX_FILES["sbix"],
        {
            **common,
            ...
            "fixtures": ["cjk_rtl_color_glyph_closeout_sbix_png"],
        },
    )
    write_json(MATRIX_FILES["sbix_results"], pages.get("cjk_rtl_color_glyph_closeout_sbix_png", {}))
    write_json(
        MATRIX_FILES["cbdt"],
        {
            **common,
            ...
            "proof": "renderer shares the same safe RasterGlyphImage decode branch proven by cjk_rtl_color_glyph_closeout_sbix_png; no installed CBDT/CBLC font exists in the target-local Windows font set",
    ...
    write_json(
        MATRIX_FILES["korean"],
        {
            **common,
            "status": "implemented_and_proven",
            "fixtures": ["cjk_rtl_color_glyph_closeout_korean_hangul"],
            "coverage": ["Hangul syllables", "compatibility jamo", "embedded Malgun Gothic", "Identity-H painting", "no ToUnicode dependency"],
        },
    )
    write_json(MATRIX_FILES["korean_results"], pages.get("cjk_rtl_color_glyph_closeout_korean_hangul", {}))
    write_json(
        MATRIX_FILES["hebrew"],
        {
            **common,
            "status": "implemented_and_proven",
            "fixtures": ["cjk_rtl_color_glyph_closeout_hebrew_rtl"],
    ...
    write_json(MATRIX_FILES["hebrew_results"], pages.get("cjk_rtl_color_glyph_closeout_hebrew_rtl", {}))
    write_json(
        MATRIX_FILES["cff"],
        {
            **common,
            ...
            "fixtures": ["cjk_rtl_color_glyph_closeout_cid_keyed_cff_clip"] if "cjk_rtl_color_glyph_closeout_cid_keyed_cff_clip" in pages else [],
        },
    )
    write_json(MATRIX_FILES["cff_results"], pages.get("cjk_rtl_color_glyph_closeout_cid_keyed_cff_clip", {"status": "fixture_unavailable"}))
    write_json(
        MATRIX_FILES["hinting"],
        {
            ...
            "native_hinting": "future optional feature only, not required for CJK RTL Color Glyph Closeout corpus thresholds",
        },
    )
...
def write_closure_audit(render_payload: dict[str, Any] | None) -> None:
    ...
    write_json(
        ...
        {
            "schema_version": 1,
            "kind": "cjk_rtl_color_glyph_closeout_closure_audit",
...
def run_feature_report(timeout: int) -> dict[str, Any]:
    ...
    has_cjk_rtl_color_glyph_closeout = False
    if PUBLIC_FEATURE_REPORT.exists():
        payload = json.loads(PUBLIC_FEATURE_REPORT.read_text(encoding="utf-8"))
        has_cjk_rtl_color_glyph_closeout = "cjk_rtl_color_glyph_closeout_color_glyph_cjk_rtl_fidelity_closure" in payload.get("report", {})
    return {
        "status": "passed" if result["exit_status"] == 0 and has_cjk_rtl_color_glyph_closeout else "failed",
        "has_cjk_rtl_color_glyph_closeout_section": has_cjk_rtl_color_glyph_closeout,
...
def main() -> int:
    ...
    if not args.skip_feature_report:
        ...
        write_json(OUT_DIR / "cjk_rtl_color_glyph_closeout-binding-report-parity.json", feature)
