...
def main() -> None:
    ...
    write_json(ARTIFACT_ROOT / "prompt22-wasm-package-posture.json", {"schema_version": "prompt22.wasm-posture.v1", "zopfli_native_code": False, "wasm_check": "cargo check -p wellfriendpdf-wasm --target wasm32-unknown-unknown", "external_fetch": False})
    ...
    write_json(ARTIFACT_ROOT / "prompt22-qpdf-validation.json", {"schema_version": "prompt22.qpdf-validation.v1", "status": "reference_optional_pending_local_tool", "wellfriendpdf_reopen_required": True, "unavailable_not_passed": True})
