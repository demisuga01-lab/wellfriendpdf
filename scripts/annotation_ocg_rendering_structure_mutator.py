#!/usr/bin/env python3
"""Annotation Ocg Rendering structure-aware PDF mutator.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate Annotation Ocg Rendering structure-aware PDF mutations.")
    parser.add_argument("input", type=Path)
    parser.add_argument("--out-dir", type=Path, default=Path("target/annotation_ocg_rendering-structure-mutations"))
