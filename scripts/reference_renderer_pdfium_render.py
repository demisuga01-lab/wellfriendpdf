#!/usr/bin/env python3
"""Reference Renderer target-local PDFium renderer wrapper.
...
small pdfium_test-compatible argument subset used by the Native Renderer reference
adapter and a direct JSON/version mode for the Reference Renderer bootstrap manifest.
"""
