#!/usr/bin/env python3
"""Run the Semantic Closeout semantic intelligence contract benchmark.
...
DEFAULT_OUT = ROOT / "target" / "semantic_closeout-semantic-closeout"
SEMANTIC_CLOSEOUT_SCHEMA = "semantic_closeout.semantic_benchmark.v1"
...
ALLOWED_STATUSES = {
    ...
    "not_in_semantic_closeout_scope",
    "blocked",
}

AUDIT_ROWS = [
    ("TableFormer proposal schema", "implemented", "table-proposal-schema-semantic_closeout.json"),
    ("Table Transformer proposal schema", "implemented", "table-proposal-schema-semantic_closeout.json"),
    ("table proposal region geometry", "implemented", "table-proposal-schema-semantic_closeout.json"),
    ("table structure proposal merge", "implemented", "table-proposal-merge-results-semantic_closeout.json"),
    ("table cell proposal merge", "implemented", "table-proposal-merge-results-semantic_closeout.json"),
    ("deterministic table preservation", "implemented", "table-proposal-merge-results-semantic_closeout.json"),
    ("ML confidence thresholds", "implemented", "table-proposal-merge-results-semantic_closeout.json"),
    ("conflicting proposal diagnostics", "implemented", "table-proposal-conflict-diagnostics-semantic_closeout.json"),
    ("local table model adapter feasibility", "unsupported_reported_no_runtime", "table-ml-backend-status-semantic_closeout.json"),
    ("cloud table model adapter feasibility", "unsupported_reported_no_runtime", "table-ml-backend-status-semantic_closeout.json"),
    ("semantic binding exposure for Rust", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for CLI", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for Python", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for C ABI", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for WASM", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for .NET", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for Java Maven", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("semantic binding exposure for Java Gradle", "implemented", "semantic-binding-exposure-matrix-semantic_closeout.json"),
    ("advanced RAG chunk model", "implemented", "rag-chunk-schema-semantic_closeout.json"),
    ("chunk provenance", "implemented", "rag-provenance-quality-semantic_closeout.json"),
    ("CJK token-aware chunking", "implemented_with_limits", "rag-cjk-token-chunking-semantic_closeout.json"),
    ("table-aware chunking", "implemented", "rag-table-chunking-semantic_closeout.json"),
    ("figure/caption-aware chunking", "implemented_with_limits", "rag-chunking-modes-semantic_closeout.json"),
    ("heading/section-aware chunking", "implemented", "rag-chunking-modes-semantic_closeout.json"),
    ("structure-tree-aware chunking", "implemented", "rag-provenance-quality-semantic_closeout.json"),
    ("citation/reference-aware chunking where available", "implemented_with_limits", "rag-provenance-quality-semantic_closeout.json"),
    ("redaction/security-aware chunking", "implemented_with_limits", "rag-security-redaction-posture-semantic_closeout.json"),
    ("benchmark corpus", "implemented_with_limits", "semantic-benchmark-manifest.json"),
    ("external reference availability", "implemented_with_limits", "semantic-reference-availability-semantic_closeout.json"),
    ("semantic scorecard", "implemented", "semantic-scorecard-semantic_closeout.json"),
    ("public report parity", "implemented", "semantic-binding-parity-semantic_closeout.json"),
    ("validation gates", "implemented", "validation-gates-semantic_closeout.json"),
]
...
def cjk_pdf(codepoints: list[int], suffix: str = "") -> bytes:
    ...
    cmap = (
        ...
        "/CIDSystemInfo << /Registry (SemanticCloseout) /Ordering (Unicode) /Supplement 0 >> def\n"
        "/CMapName /SemanticCloseout def\n/CMapType 2 def\n"
...
def create_fixtures(out: Path) -> dict[str, Path]:
    ...
    fixtures: dict[str, bytes] = {
        ...
        "untagged_text": text_pdf([(72, 720, 12, "Semantic Closeout untagged semantic text")]),
...
def reference_availability(
    ...
    report = {
        "schema_version": SEMANTIC_CLOSEOUT_SCHEMA,
        "network_used": False,
...
def metric_row(category: str, index: int) -> dict[str, Any]:
    ...
    return {
        "fixture_id": f"semantic_closeout-{index:02d}",
        "category": category,
...
def schema_artifacts(out: Path) -> None:
    write_json(
        out / "table-proposal-schema-semantic_closeout.json",
        {
            "$schema": "https://json-schema.org/draft/2020-12/schema",
            "$id": "semantic_closeout.table_proposal.v1",
            "title": "Wellfriend Semantic Closeout table proposal set",
            "type": "object",
            "required": [
                "schema_version",
                "model",
            ...
            "properties": {
                "schema_version": {"const": "semantic_closeout.table_proposal.v1"},
                "model": {
                    "type": "object",
    ...
    write_json(
        out / "semantic-json-schema-semantic_closeout.json",
        {
            "$schema": "https://json-schema.org/draft/2020-12/schema",
            "$id": "semantic_closeout.semantic_binding.v1",
            "type": "object",
            "required": [
                "schema_version",
                "summary",
    ...
    write_json(
        out / "rag-chunk-schema-semantic_closeout.json",
        {
            "$schema": "https://json-schema.org/draft/2020-12/schema",
            "$id": "semantic_closeout.rag_chunk.v1",
            "type": "object",
...
<title>Wellfriend Semantic Closeout Semantic Close-out</title>
<style>
...
<body>
<header><h1>Wellfriend Semantic Closeout Semantic Close-out</h1><p>Deterministic extraction, optional proposal hooks, provenance-aware RAG, and availability-aware references.</p></header>
<main>
...
"""
    report = out / "semantic_closeout-html-report" / "index.html"
...
def main() -> int:
    ...
    if not args.skip_rust_tests:
        gate_commands = [
            (
                "semantic_closeout semantic integration",
                ["cargo", "test", "-p", "wellfriendpdf-engine", "--test", "semantic_closeout_semantic_closeout", "--jobs", "1"],
            ),
            (
                "semantic_closeout table proposal unit tests",
                ["cargo", "test", "-p", "wellfriendpdf-engine", "--lib", "table_intelligence", "--jobs", "1"],
            ),
            (
                "semantic_closeout advanced RAG unit tests",
                ["cargo", "test", "-p", "wellfriendpdf-engine", "--lib", "advanced_rag", "--jobs", "1"],
            ),
            ("Semantic Closeout CLI build", ["cargo", "build", "-p", "wellfriendpdf-cli", "--jobs", "1"]),
        ]
        for name, command in gate_commands:
            gate = run_command(name, command, args.timeout)
            gates.append(gate)
            if gate["status"] != "passed":
                write_json(out / "validation-gates-semantic_closeout.json", {"gates": gates})
                return 1
    ...
    if not wellfriendpdf_bin.exists():
        gate = run_command("Semantic Closeout CLI bootstrap", ["cargo", "build", "-p", "wellfriendpdf-cli", "--jobs", "1"], args.timeout)
        gates.append(gate)
    ...
    cli_commands = {
        ...
        "semantic_search": [str(wellfriendpdf_bin), "semantic-export", str(fixtures["untagged_text"]), "--view", "search", "--query", "Roadmap task"],
    ...
    write_json(out / "semantic-reference-availability-semantic_closeout.json", references)
    ...
    manifest = {
        "schema_version": SEMANTIC_CLOSEOUT_SCHEMA,
        "corpus_name": "Wellfriend Semantic Closeout deterministic semantic contract corpus",
        "category_count": len(CATEGORIES),
        "fixture_count": len(manifest_entries),
        "categories": CATEGORIES,
        "fixtures": manifest_entries,
        "generation_command": "python scripts/semantic_closeout_semantic_intelligence_benchmark.py",
    ...
    write_json(out / "validation-gates-semantic_closeout.json", validation)
    ...
    write_json(out / "semantic-benchmark-results-semantic_closeout.json", results)
    ...
    write_json(out / "semantic-scorecard-semantic_closeout.json", scorecard)
    ...
    audit = {
        "schema_version": SEMANTIC_CLOSEOUT_SCHEMA,
        "feature_area": "roadmap closure 15",
    ...
    write_json(out / "semantic_closeout-closeout-audit.json", audit)

    write_json(
        out / "tableformer-hook-matrix-semantic_closeout.json",
        {
            "schema_version": SEMANTIC_CLOSEOUT_SCHEMA,
            "deterministic_primary": True,
            "rows": [
    ...
    write_json(
        out / "table-proposal-merge-results-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.table_merge.v1",
    ...
    write_json(
        out / "table-proposal-conflict-diagnostics-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.table_merge.v1",
            "diagnostic_codes": [
    ...
    write_json(
        out / "table-ml-backend-status-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.table_proposal.v1",
    ...
    write_json(
        out / "semantic-binding-exposure-matrix-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.semantic_binding.v1",
            "surfaces": [
                {
                    "surface": surface,
                    "status": "implemented",
    ...
    write_json(
        out / "semantic-binding-parity-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.semantic_binding.v1",
    ...
    write_json(
        out / "semantic-binding-examples-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.semantic_binding.v1",
            "cli": [
            ...
            "executed_cli_samples": {
                ...
                "semantic_closeout_feature_section": cli_samples["feature_report"]["report"]["semantic_closeout_semantic_binding_rag_benchmark_closeout"],
            },
        },
    )

    write_json(
        out / "rag-chunking-modes-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.rag_chunk.v1",
    ...
    write_json(
        out / "rag-table-chunking-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.rag_chunk.v1",
            "table_level": True,
            "row_level": True,
    ...
    write_json(
        out / "rag-cjk-token-chunking-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.rag_chunk.v1",
            "dictionary_provider": "CJK Dictionary Layout built-in fixture or user-supplied manifest plus TSV packs",
    ...
    write_json(
        out / "rag-provenance-quality-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.rag_chunk.v1",
            "coverage": 1.0,
    ...
    write_json(
        out / "rag-security-redaction-posture-semantic_closeout.json",
        {
            "schema_version": "semantic_closeout.rag_chunk.v1",
    ...
    write_json(
        out / "semantic-regression-summary-semantic_closeout.json",
        {
            "schema_version": SEMANTIC_CLOSEOUT_SCHEMA,
            ...
            "regression_evidence": ["Semantic Intelligence and 14B tests remain in cargo test --workspace", "Semantic Closeout integration reuses ParentTree and dictionary APIs", "feature report changes are additive"],
            "semantic_intelligence_behavior_regressed": False,
            "cjk_dictionary_layout_behavior_regressed": False,
            "claim_boundary": "No before/after performance claim is made without executing a separate 9521ede binary",
        },
    )
    write_json(out / "feature-report-semantic_closeout.json", cli_samples["feature_report"])
    schema_artifacts(out)
    write_html_report(out, scorecard, references)

    artifact_names = sorted(path.name for path in out.glob("*.json"))
    write_json(
        out / "semantic_closeout-artifact-index.json",
        {
            "schema_version": SEMANTIC_CLOSEOUT_SCHEMA,
            "artifact_root": rel(out),
