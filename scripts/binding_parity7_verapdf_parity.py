#!/usr/bin/env python3
"""Crypto Standards Fuzz veraPDF corpus parity runner.
...
SCHEMA_VERSION = "crypto_standards_fuzz.verapdf-parity.v1"
...
def corpus_manifest(corpus: Path, files: list[Path]) -> dict[str, object]:
    ...
    return {
        "schema_version": "crypto_standards_fuzz.verapdf-corpus-manifest.v1",
...
def tool_manifest(verapdf_bin: Path | str) -> dict[str, object]:
    ...
    return {
        "schema_version": "crypto_standards_fuzz.verapdf-tool-manifest.v1",
        "generated_at_utc": utc(),
        "tool": "veraPDF",
        "path": resolved,
...
def main() -> int:
    ...
    parser.add_argument("--markdown-output", type=Path, default=Path("docs/crypto_standards_fuzz_verapdf_parity.md"))
    ...
    mismatch = {
        "schema_version": "crypto_standards_fuzz.verapdf-mismatch-classification.v1",
        "generated_at_utc": utc(),
    ...
    pdfa4 = {
        "schema_version": "crypto_standards_fuzz.pdfa4-parity.v1",
        "generated_at_utc": utc(),
