...
WELLFRIENDPDF_REPORT_DIR = OUT_DIR / "prompt10c-wellfriendpdf-render-reports"
...
def render_compare(
    ...
    summary = {
        ...
        "wellfriendpdf_outlier_failures": sum(
            1
            for page in pages
            if page["prompt10c_classification"] in {"wellfriendpdf_outlier_failure", "wellfriendpdf_render_failure"}
        ),
