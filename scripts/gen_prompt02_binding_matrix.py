...
EXTRA_ROWS = [
    ...
    },
    {
        ...
        "surfaces": {"wasm": DEF, "dotnet": DEF, "java": PART, "docs": PUB, "packaging": PART},
        "note": "pom.xml records Maven metadata; local smoke still uses javac/java because the FFM preview flags are host-JDK sensitive.",
    },
    {
    ...
    },
    {
        ...
        "surfaces": {"wasm": UNSUP, "dotnet": UNSUP, "java": UNSUP, "docs": PUB, "packaging": PUB},
        "note": "No binding-level cancellation claims; matrix records unsupported status.",
    },
    {
