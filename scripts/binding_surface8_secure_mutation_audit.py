#!/usr/bin/env python3
"""Generate the Combined secure mutation audit bundle from executable gates.
...
OUT = ROOT / "target" / "secure_mutation-mask-inline-associated-signatures"
SCHEMA = "secure_mutation.mask-inline-associated-signature-policy.v1"
ARTIFACT_BY_FEATURE = {
    "image_mask": "stencil-mask-redaction-results-secure_mutation.json",
    "explicit_mask": "explicit-mask-redaction-results-secure_mutation.json",
    "soft_mask_matte": "softmask-redaction-results-secure_mutation.json",
    "shared_mask_clone": "shared-mask-clone-results-secure_mutation.json",
    "color_key_mask": "color-key-mask-redaction-results-secure_mutation.json",
    "inline_parser": "inline-image-parser-matrix-secure_mutation.json",
    "inline_sample_rewrite": "inline-image-rewrite-results-secure_mutation.json",
    "inline_filter_chain": "inline-image-redaction-format-matrix-secure_mutation.json",
    "associated_inventory": "associated-files-inventory-secure_mutation.json",
    "associated_extract": "associated-files-extraction-security-secure_mutation.json",
    "associated_add_remove": "associated-files-add-remove-results-secure_mutation.json",
    "associated_dedup": "associated-files-dedup-results-secure_mutation.json",
    "associated_sanitizer": "associated-files-sanitizer-results-secure_mutation.json",
    "docmdp_fieldmdp": "docmdp-fieldmdp-structural-results-secure_mutation.json",
    "edit_policy_decision": "signature-edit-policy-matrix-secure_mutation.json",
    "incremental_prefix": "incremental-edit-prefix-results-secure_mutation.json",
    "secure_mutation_binding_parity": "secure_mutation-artifact-manifest.json",
    "indexed_iccbased": "mask-redaction-inventory-secure_mutation.json",
    "dct_jpx_ccitt_jbig2": "mask-redaction-security-proof-secure_mutation.json",
    "nested_form_transparency": "mask-redaction-geometry-secure_mutation.json",
    "mask_cycles_depth": "secure_mutation-limit-denial-results.json",
    "hidden_color_alpha": "mask-redaction-security-proof-secure_mutation.json",
    "inline_raw_flate": "inline-image-rewrite-results-secure_mutation.json",
    "inline_ascii_wrappers": "inline-image-redaction-format-matrix-secure_mutation.json",
    "inline_runlength": "inline-image-redaction-format-matrix-secure_mutation.json",
    "inline_image_filters": "inline-image-redaction-format-matrix-secure_mutation.json",
    "inline_indexed_imagemask": "inline-image-security-proof-secure_mutation.json",
    "inline_malformed_ei": "inline-image-parser-matrix-secure_mutation.json",
    "catalog_page_af": "associated-files-location-matrix-secure_mutation.json",
    "annotation_structure_af": "associated-files-location-matrix-secure_mutation.json",
    "xobject_form_af": "associated-files-location-matrix-secure_mutation.json",
    "richmedia_xfa_fdf_refs": "associated-files-location-matrix-secure_mutation.json",
    "external_platform_specs": "associated-files-extraction-security-secure_mutation.json",
    "unicode_metadata": "associated-files-inventory-secure_mutation.json",
    "portfolio_collection": "portfolio-collection-report-secure_mutation.json",
    "form_annotation_policy": "form-edit-signature-impact-secure_mutation.json",
    "page_content_policy": "page-edit-signature-impact-secure_mutation.json",
    "redaction_sanitizer_policy": "redaction-sanitizer-signature-impact-secure_mutation.json",
    "attachment_xfa_policy": "attachment-edit-signature-impact-secure_mutation.json",
    "canonicalize_full_rewrite_policy": "signature-edit-policy-matrix-secure_mutation.json",
}
...
def feature(category: str, feature_id: str, status: str, security: str, limit: str) -> dict:
    return {
        ...
        "fixture": "crates/engine/tests/secure_mutation_secure_mutation.rs",
        "test": "secure_mutation_secure_mutation",
...
def main() -> int:
    ...
    starting = {
        ...
        "expected_annotation_media_redaction_checkpoint": "d0842aae76b536f8ccc82d26f1a5a8054889ad49",
    ...
    write("secure_mutation-starting-state.json", starting)
    ...
    rows = [
        ...
        feature("bindings", "secure_mutation_binding_parity", "implemented_with_limits", "versioned_owned_reports_and_bytes", "WASM is memory-only and never receives host paths"),
        ...
        feature("associated_files", "portfolio_collection", "implemented_with_limits", "schema_inventory_only", "portfolio UI rendering is not in secure mutation"),
    ...
    write("secure_mutation-feature-matrix.json", matrix)

    focused = run("cargo", "test", "-p", "wellfriendpdf-engine", "--test", "secure_mutation_secure_mutation")
    if not focused["passed"]:
        write("secure_mutation-focused-failure.json", focused)
        return focused["exit_code"] or 1

    prior_gate_path = ROOT / "target" / "release_packaging-packaging-codec-isolation" / "release-manifest.json"
    prior_gate = None
    ...
    tool_candidates = {
        "poppler_pdftoppm": list((ROOT / "target").glob("roadmap task*-tools/**/pdftoppm.exe")),
        "pdfium": list((ROOT / "target").glob("roadmap task*-tools/**/pdfium.dll")),
        "mupdf_mutool": list((ROOT / "target").glob("roadmap task*-tools/**/mutool.exe")),
        "qpdf": list((ROOT / "target").glob("roadmap task*-tools/**/qpdf.exe")),
        "pdfbox": list((ROOT / "target").glob("roadmap task*-tools/**/pdfbox*.jar")),
    }
    tools = {
    ...
    write("secure_mutation-reference-render-proof.json", reference_proof)
    ...
    common = {
        ...
        "release_packaging_release_gate": prior_gate,
        "performance": {
    ...
    artifact_names = [
        "mask-redaction-inventory-secure_mutation.json", "mask-redaction-geometry-secure_mutation.json",
        "softmask-redaction-results-secure_mutation.json", "explicit-mask-redaction-results-secure_mutation.json",
        "stencil-mask-redaction-results-secure_mutation.json", "color-key-mask-redaction-results-secure_mutation.json",
        "shared-mask-clone-results-secure_mutation.json", "mask-redaction-security-proof-secure_mutation.json",
        "mask-redaction-determinism-secure_mutation.json", "inline-image-parser-matrix-secure_mutation.json",
        "inline-image-redaction-format-matrix-secure_mutation.json", "inline-image-rewrite-results-secure_mutation.json",
        "inline-image-promotion-results-secure_mutation.json", "inline-image-security-proof-secure_mutation.json",
        "inline-image-determinism-secure_mutation.json", "associated-files-inventory-secure_mutation.json",
        "associated-files-location-matrix-secure_mutation.json", "associated-files-extraction-security-secure_mutation.json",
        "associated-files-add-remove-results-secure_mutation.json", "associated-files-dedup-results-secure_mutation.json",
        "associated-files-sanitizer-results-secure_mutation.json", "associated-files-rescan-results-secure_mutation.json",
        "portfolio-collection-report-secure_mutation.json", "associated-files-signature-impact-secure_mutation.json",
        "signature-edit-policy-matrix-secure_mutation.json", "docmdp-fieldmdp-structural-results-secure_mutation.json",
        "incremental-edit-prefix-results-secure_mutation.json", "form-edit-signature-impact-secure_mutation.json",
        "annotation-edit-signature-impact-secure_mutation.json", "page-edit-signature-impact-secure_mutation.json",
        "redaction-sanitizer-signature-impact-secure_mutation.json", "attachment-edit-signature-impact-secure_mutation.json",
        "signature-safe-edit-reopen-results-secure_mutation.json", "secure_mutation-corpus-manifest.json",
        "secure_mutation-reference-results.json", "secure_mutation-diff-metrics.json",
        "secure_mutation-reference-disagreements.json", "secure_mutation-metamorphic-results.json",
        "secure_mutation-performance-memory.json", "secure_mutation-limit-denial-results.json",
    ]
    corpus_categories = [
    ...
    for name in artifact_names:
        ...
        payload.update({
            ...
            "exact_limit": (
                ...
                else "see secure_mutation-feature-matrix.json and docs/secure_mutation_known_limits.md"
            ),
        })
        write(name, payload)
    ...
    write("secure_mutation-artifact-manifest.json", manifest)
    html = OUT / "secure_mutation-html-report" / "index.html"
    html.parent.mkdir(parents=True, exist_ok=True)
    html.write_text(
        "<!doctype html><meta charset='utf-8'><title>secure mutation audit</title>"
        "<h1>secure mutation secure mutation audit</h1>"
