#!/usr/bin/env python3
"""Roadmap task H Wellfriend-vs-Poppler performance proof harness.
...
def write_markdown(results: dict, out_path: Path) -> None:
    ...
    lines = [
        "# Roadmap task H Performance Results",
        "",
...
def main() -> None:
    ...
    rows = []
    print(
        f"# Roadmap task H perf: repeats={args.repeats} dpi={args.dpi} threads=1,{args.threads}"
    )
