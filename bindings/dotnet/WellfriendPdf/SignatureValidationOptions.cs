...
public sealed class SignatureValidationOptions : IDisposable
{
    ...
    {
        _handle = NativeMethods.wellfriendpdf_signature_validation_options_new(out var error);
    ...
    public void AddTrustAnchorDer(byte[] der) => AddDer(
        der,
        NativeMethods.wellfriendpdf_signature_validation_options_add_trust_anchor_der);
    ...
    public void ApplyTrustStore(SignatureTrustStore trustStore)
    {
        ...
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_apply_trust_store(
    ...
    public void AddIntermediateDer(byte[] der) => AddDer(
        der,
        NativeMethods.wellfriendpdf_signature_validation_options_add_intermediate_der);
    ...
    public void ApplyIntermediateStore(SignatureIntermediateStore intermediateStore)
    {
        ...
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_apply_intermediate_store(
    ...
    public void AddDistrustedCertificateSha256(string fingerprint)
    {
        ...
        try
        {
            var status = NativeMethods.wellfriendpdf_signature_validation_options_add_distrusted_certificate_sha256(
    ...
    public void AddOcspDer(byte[] der) => AddDer(
        der,
        NativeMethods.wellfriendpdf_signature_validation_options_add_ocsp_der);

    public void AddCrlDer(byte[] der) => AddDer(
        der,
        NativeMethods.wellfriendpdf_signature_validation_options_add_crl_der);
    ...
    public void ApplyEvidenceStore(SignatureEvidenceStore evidenceStore)
    {
        ...
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_apply_evidence_store(
    ...
    {
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_set_validation_time_unix(
    ...
    {
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_clear_validation_time(
    ...
    {
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_set_revocation_mode(
    ...
    public void SetRetrievalPolicyJson(string policyJson)
    {
        ...
        try
        {
            var status = NativeMethods.wellfriendpdf_signature_validation_options_set_retrieval_policy_json(
    ...
    public void ApplyRetrievalPolicy(SignatureRetrievalPolicy policy)
    {
        ...
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_apply_retrieval_policy(
    ...
    public void SetCancellation(SignatureValidationCancellation cancellation)
    {
        ...
        ThrowIfDisposed();
        var status = NativeMethods.wellfriendpdf_signature_validation_options_set_cancellation(
    ...
    public void SetAlgorithmPolicyJson(string policyJson)
    {
        ...
        try
        {
            var status = NativeMethods.wellfriendpdf_signature_validation_options_set_algorithm_policy_json(
                _handle, policy, out var error);
            NativeMethods.ThrowIfError(status, error);
        }
        finally
    ...
    public void SetEvidenceBundleJson(string bundleJson)
    {
        ...
        try
        {
            var status = NativeMethods.wellfriendpdf_signature_validation_options_set_evidence_bundle_json(
    ...
    public void SetPathLimits(nuint maxChainDepth, nuint maxPathCandidates)
    {
        ...
        var status = NativeMethods.wellfriendpdf_signature_validation_options_set_path_limits(
