...
internal static partial class NativeMethods
{
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int wellfriendpdf_document_default_render_contract_json(
        DocumentHandle document,
        UIntPtr page,
        uint dpi,
        IntPtr renderMode,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int wellfriendpdf_document_render_into_buffer_with_contract_json(
        DocumentHandle document,
        IntPtr contractJson,
        [Out] byte[] output,
        UIntPtr outputLen,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int wellfriendpdf_runtime_effective_config_json(
        IntPtr configJson,
        out IntPtr json,
        out IntPtr errorOut);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int wellfriendpdf_runtime_capabilities_json(
        IntPtr configJson,
        out IntPtr json,
        out IntPtr errorOut);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern int wellfriendpdf_ocr_provider_matrix_json(
        out IntPtr json,
        out IntPtr errorOut);
