...
#[test]
fn prompt11_full_tile_band_and_tile_size_equivalence() {
    let cases = [
...
#[test]
fn prompt11_cache_cold_warm_and_no_cache_are_equivalent() {
...
#[test]
fn prompt11_progressive_resume_matches_uninterrupted_render() {
...
#[test]
fn prompt11_cancelled_render_does_not_poison_later_render() {
    let engine = ContentEngine::open_bytes(simple_pdf("1 0 0 rg 0 0 100 100 re f\n"))
        .expect("open vector pdf");
