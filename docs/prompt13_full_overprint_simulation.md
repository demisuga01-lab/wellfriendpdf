# Prompt 13 Full Overprint Simulation

Prompt 13 adds a bounded overprint state model to the existing prepress plate
...
- Text, vector, image, shading, and tiling-pattern plate paths write Prompt 13
  posture rows where their Prompt 12B plate path is representable.
...
- Certification-grade PDF/X validation is not part of Prompt 13.
