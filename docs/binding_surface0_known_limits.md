# Multilingual Color Glyphs Known Limits

Porterduff Radial Color Glyph closes the remaining Multilingual Color Glyphs COLRv1 composite and moving-center
...
- CJK RTL Color Glyph Closeout, Color Glyph Hinting, Colrv Svg Bitmap, Colrv Gradient Composite, and Porterduff Radial Color Glyph multi-reference audits
