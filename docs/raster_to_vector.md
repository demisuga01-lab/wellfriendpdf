...
Prompt 21 exposes bounded raster-to-vector analysis through `oxide_engine::prompt21::raster_vectorization_report`, CLI commands `raster-vector-report` and `raster-vectorize`, and SDK/binding report wrappers.
