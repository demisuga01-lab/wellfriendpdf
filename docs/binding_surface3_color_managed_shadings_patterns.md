# Prepress Proofing Color-Managed Shadings and Patterns
...
handling where supported, and the Nchannel Plate Prepress separation framebuffer.

Shadings:

- axial and radial shadings use the renderer color interpolation path.
- mesh and patch shadings use the Advanced Rendering/08B geometry path, with color
...
- pattern matrix, cell identity, plate visibility, and overprint state
  participate in the Prepress Proofing cache/equivalence artifacts.
