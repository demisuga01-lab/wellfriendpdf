# Transparency Rendering Transparency Compositing Architecture

Transparency Rendering extends the Native Renderer native replay path with a bounded native
...
Every Transparency Rendering offscreen surface is admitted through the renderer decode
...
optimization for a later renderer roadmap task.
...
- Transparency Closeout exercises explicit DeviceGray, DeviceRGB, and DeviceCMYK group
...
Advanced Rendering owns shadings and patterns. This architecture is designed so those
