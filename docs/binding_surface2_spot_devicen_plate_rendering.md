# Prepress CMM Spot And DeviceN Plate Rendering
...
Supported Prepress CMM write paths:
...
Nchannel Plate Prepress extends supported write paths:
...
report-visible or fail closed. Full overprint compositing remains Prepress Proofing.
