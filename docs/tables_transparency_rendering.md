# Transparency Rendering Tables

Wellfriend's table engine remains classical and CPU-safe. Transparency Rendering documents and
...
3. Stream mode from Reference Renderer word geometry and row/column alignment.
...
Transparency Rendering baseline:

- `target/competitive-benchmark/transparency_rendering-tables-before`
