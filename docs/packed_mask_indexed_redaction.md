...
Oxide rewrites packed rows in sample space for one-bit stencils and 1/2/4/8-bit Indexed images. Row padding is decoded and rebuilt exactly. The polygon is inverse-mapped through the active image CTM; non-finite or singular mappings fail closed.
