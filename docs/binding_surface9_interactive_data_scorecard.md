# form action policy Interactive / Data Scorecard

form action policy removes the vague “interactive edge cases later” bucket. The public
...
content, deterministic-writer, and secure mutation closeout signature-policy surfaces.
...
- popup/reply and appearance edge cases retain annotation/media redaction exact limits;
