# document security Known Limits

document security implements production code paths for accessibility repair, redaction,
...
- complete corpus-level accessibility, standards, differential, and historical
  gate replay is deferred to release validation.
