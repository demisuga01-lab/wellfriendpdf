# Prepress CMM Backend Packaging Policy
...
Nchannel Plate Prepress reports native and fallback behavior through the same additive public
...
Packaging and binding smokes must assert the Nchannel Plate Prepress report section across:
