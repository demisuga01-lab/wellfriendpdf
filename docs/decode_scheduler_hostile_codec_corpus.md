# Decode Scheduler Hostile Codec Corpus

The hostile codec corpus is generated, not committed as binary blobs:

```powershell
python scripts\decode_scheduler_hostile_codec_corpus.py generate
python scripts\decode_scheduler_hostile_codec_corpus.py run --wellfriendpdf-bin target\debug\wellfriendpdf.exe
```

Artifacts:

- Manifest: `target/decode_scheduler-codec-closeout/hostile-corpus-manifest.json`
- Fixtures: `target/decode_scheduler-codec-closeout/hostile-corpus/`
- Run report: `target/decode_scheduler-codec-closeout/hostile-corpus-run.json`
