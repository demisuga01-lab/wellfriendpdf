...
Prompt 20B focused fixtures cover depth two and depth three invocation paths,
including deterministic clone graphs and undo/redo through
`Prompt20MutationSession`. The audit harness records invocation-path, clone
