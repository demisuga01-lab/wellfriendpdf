# Prompt 13 Prepress Proofing Benchmark

The benchmark entrypoint is:

```powershell
python scripts/prompt13_prepress_benchmark.py
```

It writes artifacts under `target/prompt13-prepress-closeout/` and covers 18
