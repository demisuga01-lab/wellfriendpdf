# Prompt 10F COLRv1 Porter-Duff And Radial Closure

Prompt 10F closes the final Prompt 10 color-glyph correctness gaps left after
Prompt 10E:
...
continue to use the Prompt 07/07B blend machinery.
...
Artifacts live under `target/prompt10-cjk-rtl-color-glyph-reference/`, including
`prompt10f-closure-audit.json`, Porter-Duff/radial matrices, multi-reference
