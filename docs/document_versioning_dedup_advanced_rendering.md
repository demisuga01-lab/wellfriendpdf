...
Advanced Rendering adds small deterministic helpers for future writer/versioning work.
...
- writer-level resource dedup by digest is not yet globally enabled; Type3 CID Rendering
