...
Prompt 17 modes are `inventory_only`, `preserve_inert`, `remove_active_content`, `remove_all_media`, `flatten_static_poster`, and `custom`. Reports state what remained, what was removed or flattened, whether payloads/URLs/annotations/AP remain, signature impact, rescan status, and residual risk.
