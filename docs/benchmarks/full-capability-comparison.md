...
|---|---:|---:|---:|---:|---:|---:|---|
| Wellfriend current, document-scoped cache | 5044/5044 | 0 | 116975 | 572.8 | 3224.5 | 10503.9 | `wellfriend-render-all-pages-document-cache-w8-summary.json` |
