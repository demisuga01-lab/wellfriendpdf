...
Wrapper relationships are disclosed: pypdfium2 wraps PDFium; PyMuPDF wraps MuPDF. MuPDF `mutool`, Poppler `pdftoppm`, PDFBox, and PDF.js are separate execution paths.
