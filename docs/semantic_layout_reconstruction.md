...
The runtime reconstruction path reuses the Native Renderer semantic model and
...
Semantic reconstruction now uses the existing Native Renderer semantic text model
...
paragraph is selected by deterministic source-text identity plus source editing
