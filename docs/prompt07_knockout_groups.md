# Prompt 07 Knockout Groups

Prompt 07B changes knockout groups from a final flatten-time approximation to a
...
- Audit: `target/prompt07-transparency-compositing/prompt07b-transparency-matrix.json`.

Remaining later-owned limits are text clipping and Prompt 08 pattern/shading
