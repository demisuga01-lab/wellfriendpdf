# Transparency Rendering Page Operations

Transparency Rendering adds a page-operation audit report so callers can understand what
...
Transparency Closeout adds `crop_pages`, which writes `/CropBox` values in the preserved
...
- Existing signatures may be invalidated by page operations. Annotation Ocg Rendering owns
