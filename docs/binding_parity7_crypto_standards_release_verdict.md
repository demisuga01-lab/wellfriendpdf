# Crypto Standards Fuzz crypto and standards release verdict

The release verdict is generated at:

- `target/crypto_standards_fuzz-verapdf-crypto-fuzz/crypto-standards-release-verdict.json`

The verdict can only be release-grade when:

- crypto writer closeout, 24B, 25B, and 26 focused gates pass or are rerun with exact scoped
  equivalents.
...
If any security failure remains unclassified, Crypto Standards Fuzz is not complete.
