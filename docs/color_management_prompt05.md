# Prompt 05 Color Management

Prompt 05 makes the existing color layer inspectable, bounded, and usable as a
...
Stable diagnostic codes added in Prompt 05 include:
...
| feature | Prompt 05 status | bounded limit |
| --- | --- | --- |
...
Prompt 05 created a deterministic 24-file color/prepress slice under
`target/prompt05-color-baseline-manifest.json` from existing corpus entries:
...
| metric | baseline | after Prompt 05 |
| --- | ---: | ---: |
| files | 24 | 24 |
