# Prepress CMM Prepress Known Limits

Prepress CMM intentionally does not claim:
...
- multicolor ICC profiles are inventoried; Nchannel Plate Prepress adds the bounded
...
- plate identity survives in the sampled n-channel separation framebuffer;
  Prepress Proofing adds the bounded overprint/prepress close-out on top of this
  baseline.
