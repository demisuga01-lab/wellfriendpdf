...
- `all_references_agree_oxide_pass`: Poppler, PDFium, MuPDF, and Oxide render inside the configured visual threshold.
- `reference_disagreement_oxide_inside_cluster`: reference engines disagree, and Oxide matches one reference or remains inside a documented policy cluster.
...
- `oxide_outlier_failure`: references agree and Oxide is outside threshold.
