# Release Packaging Codec Isolation User Guide
...
## Codec Boundary Additions

Codec Boundary adds an enforceable native/C codec boundary on top of the Release Packaging subprocess worker:
...
The feature report also exposes Codec Boundary scanner, renderer scheduler, and RLBox/WASM posture under `report.codec_boundary`. The SDK envelope version remains `1`.
