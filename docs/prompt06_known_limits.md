# Prompt 06 Known Limits

Prompt 06 and Prompt 06B close the native replay foundation and the
...
Prompt 06B changes the evidence quality, not these renderer limits. The same
Prompt 06 corpus is now compared against Poppler, PDFium, and MuPDF, and
