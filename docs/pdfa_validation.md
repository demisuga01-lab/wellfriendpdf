...
The Prompt 26 PDF/A API produces a clause-mapped `StandardsValidationReport`, not a boolean.
...
`deferred_prompt27_corpus_parity` result and never a conformant result.
