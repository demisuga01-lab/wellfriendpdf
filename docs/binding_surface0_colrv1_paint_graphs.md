# Multilingual Color Glyphs COLRv1 Paint Graphs

Color Glyph Hinting implemented the initial safe COLRv1 solid/transform subset. Roadmap task
10D preserved that behavior while SVG and bitmap color glyph closure proceeded.
Colrv Gradient Composite added the bounded glyph paint-surface model needed for COLRv1
gradients, clips, and PDF blend-mode composites. Porterduff Radial Color Glyph closes the remaining
...
## Porterduff Radial Color Glyph Closure

No Multilingual Color Glyphs COLRv1 composite operator remains broadly unsupported. Porter-Duff
...
- `colrv1-porterduff-composite-matrix-porterduff_radial_color_glyph.json`
- `colrv1-porterduff-composite-reference-results-porterduff_radial_color_glyph.json`
- `colrv1-exact-radial-gradient-matrix-porterduff_radial_color_glyph.json`
- `colrv1-exact-radial-gradient-reference-results-porterduff_radial_color_glyph.json`
