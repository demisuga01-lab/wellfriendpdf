...
This is a repaired-font/eligibility report, not a claim that Oxide recovered the original font family. Deterministic names use an Oxide prefix and object number, and unresolved glyphs remain explicit.
