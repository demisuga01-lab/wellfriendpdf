# Prompt 14 ML Layout Hook Interface

Prompt 14 defines a backend-neutral layout proposal interface. The hook is
...
- prompt 14 provides mock/template backends and schema validation
