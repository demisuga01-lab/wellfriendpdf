# Prompt 33 Performance

Layout candidate shaping is bounded to 2,048 spans; semantic graph creation is
bounded to 16,384 nodes and 32,768 edges. All Prompt 33 Cargo work runs one
...
`performance-memory-results.json` in the Prompt 33 result directory.
