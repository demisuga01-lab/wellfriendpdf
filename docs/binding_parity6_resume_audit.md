# Incremental Signing Standards recovery audit

## Checkpoint

Incremental Signing Standards resumed from `291d8ea424b2e657629d3606fbf8a93b33999f98`
(`Close roadmap closure 25 timestamp ltv mdp signature edits`). The required Incremental Signing Standards
...
`target/incremental_signing_standards-incremental-signing-standards/`.
...
Crypto Standards Fuzz is not started here. PDF/A-4 full rule execution, full veraPDF corpus parity,
