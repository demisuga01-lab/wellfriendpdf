# Renderer Fuzz CMM Native CMM Backend

Renderer Fuzz CMM does not implement a LittleCMS native backend. It records a precise
...
```text
renderer_fuzz_cmm_renderer_fuzz_cmm_closeout
```
