# Native Renderer Reference Disagreement Policy

Reference Renderer compares every Native Renderer corpus page across Wellfriend, Poppler, PDFium,
...
`renderer-parity-taxonomy-reference_renderer.json`.
...
The Reference Renderer closure run recorded 10 `all_references_agree_wellfriendpdf_pass` pages
...
pass, because full transparency and soft-mask fidelity are not Reference Renderer
features.
