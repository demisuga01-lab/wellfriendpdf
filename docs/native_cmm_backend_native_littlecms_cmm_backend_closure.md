# Native CMM Backend Native LittleCMS CMM Backend Closure

Native CMM Backend closes the native CMM gap left by Renderer Fuzz CMM. Wellfriend now has an
...
- True separation framebuffers and spot/DeviceN plate preview are Prepress CMM/12B
  owners. Bounded overprint/prepress simulation is closed by Prepress Proofing.

Those are Prepress CMM/13 CMM and prepress owners.
