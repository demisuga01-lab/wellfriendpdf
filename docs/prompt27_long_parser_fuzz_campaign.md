# Prompt 27 long parser fuzz campaign
...
python scripts/release_fuzz_runner.py \
  ...
  --memory-mb 16384 \
  --max-len 262144 \
  --json-output target/prompt27-verapdf-crypto-fuzz/long-parser-fuzz-results.json
```
...
No unclassified crash, hang, timeout, or OOM can remain for Prompt 27 closure.
