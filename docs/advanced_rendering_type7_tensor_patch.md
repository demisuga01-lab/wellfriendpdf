# Advanced Rendering Type 7 Tensor Patch Shading

Type3 CID Rendering replaces the Advanced Rendering Type 7 boundary-only posture with tensor
...
- Rasterization keeps the Advanced Rendering clipping, CTM, BBox, transparency, and
...
Type3 CID Rendering includes smooth, curved-interior, clipped, transformed,
