# Native Renderer Form XObject Replay
...
- `scripts/native_renderer_native_replay_regression.py` asserts a native Form XObject
...
- Form native replay counts are recorded in
  `target/native_renderer-renderer-native-replay/native-replay-counters.json`.
...
renderer work. Native Renderer preserves metadata and fallback visibility rather than
