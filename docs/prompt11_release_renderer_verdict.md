# Prompt 11 Release Renderer Verdict

Prompt 11 establishes that the renderer parity campaign can close for the
covered corpus when the generated artifacts report:
...
With those gates met, Prompt 12 may begin advanced CMM/prepress work from the
bounded Prompt 11 CMM status. Prompt 12 must not treat qcms preview transforms as
