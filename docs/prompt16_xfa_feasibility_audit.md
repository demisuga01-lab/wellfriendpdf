...
| Full LiveCycle/AEM parity | `not_in_prompt16_scope` | No compatibility claim |

No Prompt 16-scope row is `blocked`. Exact results are generated at `target/prompt16-xfa-runtime/prompt16-xfa-feasibility-audit.json` by `scripts/prompt16_xfa_runtime_audit.py`.
