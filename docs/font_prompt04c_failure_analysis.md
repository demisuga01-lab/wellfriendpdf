# Prompt 04C Font Benchmark Failure Analysis
...
Prompt 04C did not move the aggregate pass threshold. It did produce local metric movement on the Standard14/font-edge bucket:
...
| File | Category | 04C reason | Prompt 04C classification |
| --- | --- | --- | --- |
