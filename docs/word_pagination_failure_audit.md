...
The Prompt 19 taxonomy separates structural OOXML, semantic readback, visual
...
The baseline Prompt 08B writer used one hard-coded A4 `sectPr`, so mixed page
sizes and landscape pages could not preserve pagination. Prompt 19 emits one
