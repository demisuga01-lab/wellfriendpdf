# HTML, Markdown, JSON, And RAG Exports In Advanced Rendering

Advanced Rendering adds editable-model based exports alongside the existing parse and
...
- Reference Renderer chunking remains the chunking authority.
- Advanced Rendering provides stable editable IDs, section boundaries, and provenance
