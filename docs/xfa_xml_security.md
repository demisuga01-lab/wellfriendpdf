...
Oxide uses a strict, non-resolving XML parser owned by the XFA module. It has no DTD loader, entity resolver, URL client, filesystem callback, or native XML library hook.
