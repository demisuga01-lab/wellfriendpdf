# Renderer Fuzz CMM Native CMM Feasibility and Safety Audit

Renderer Fuzz CMM audits LittleCMS/lcms2 as the native/accurate CMM candidate and
...
gain a silent native dependency, and Renderer Fuzz CMM does not introduce a separate
...
It is documentation-only in Renderer Fuzz CMM and is not a compiled Cargo feature.
