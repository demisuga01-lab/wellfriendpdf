# Advanced Rendering CID/CMap Text Clipping

Type3 CID Rendering closes the common embedded CID/CMap clipping path for text rendering
modes `4`, `5`, `6`, and `7`.
...
The Type3 CID Rendering audit has five CID/CMap clipping fixtures in the
