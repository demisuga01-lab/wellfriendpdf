...
Prompt 16 does not execute JavaScript. Scripts are inventoried with language, event, target SOM, size, SHA-256, provenance, and blocked capabilities, then receive `unsupported_reported_security_policy`.
