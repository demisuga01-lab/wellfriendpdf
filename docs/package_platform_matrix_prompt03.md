...
- TypeScript `tsc` is not claimed by Prompt 03B; generated declarations are inspected and the checked-in `wellfriendpdf.d.ts` is updated for the codec isolation method.
