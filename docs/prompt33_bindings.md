...
move up to eight pairwise-disjoint same-page vector paths through the canonical Prompt 20
...
Rust, CLI, Python, C ABI, WASM, .NET, and Java route Prompt 33 analysis,
...
Prompt 20 shared-Form policy, annotations, clipping/marked/optional-content
