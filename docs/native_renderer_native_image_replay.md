# Native Renderer Native Image Replay
...
scheduled decode helpers), preserving Codec Boundary/05 scheduler admission and image
limits rather than adding a second decode route.

Evidence:

- `scripts/native_renderer_native_replay_regression.py` asserts Image XObject and
