...
Prompt 27 introduces a reproducible veraPDF comparison runner:

```bash
python scripts/prompt27_verapdf_parity.py \
  --corpus /home/demisuga01/wellpdf/corpus/verapdf/veraPDF-corpus \
  --verapdf-bin verapdf \
  --wellfriendpdf-bin target/release/wellfriendpdf \
  --artifact-root target/prompt27-verapdf-crypto-fuzz
```
...
Supported Wellfriend executable PDF/A profiles for this prompt are PDF/A-1b, 2b, 2a,
...
veraPDF is the authoritative external comparison tool for this Prompt 27 PDF/A unit, but
