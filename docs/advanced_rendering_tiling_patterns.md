# Advanced Rendering Tiling Patterns

Advanced Rendering implements the common native path for PatternType `1` tiling patterns.
...
- Advanced Rendering text-clip pattern interaction in
  `cargo test -p wellfriendpdf-engine --test advanced_rendering_text_clip --jobs 1`

Artifacts:

- `target/advanced_rendering-text-shading-patterns/tiling-pattern-matrix.json`
- `target/advanced_rendering-text-shading-patterns/fallback-taxonomy.json`
