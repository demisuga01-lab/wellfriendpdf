# Transparency Rendering Soft Masks
...
allocation. The Transparency Rendering memory budget report uses a 4096 MB audit cap and the
...
Transparency Closeout adds focused fixtures for `image_smask_matte`,
...
- `target/transparency_rendering-transparency-compositing/soft-mask-matrix.json`
...
- `target/transparency_rendering-transparency-compositing/memory-budget-report.json`
