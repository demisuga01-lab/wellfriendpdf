...
Extraction remains independent. Prompt 06 does not change ToUnicode provenance
or semantic extraction paths; glyph replay is only a rendering concern.

Evidence:

- `scripts/prompt06_native_replay_regression.py` asserts native text counters
