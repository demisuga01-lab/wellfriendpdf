# Large-File Performance Release Packaging Report
...
- Starting point: `large-file-profile/results/release_packaging-before/`
- Content-streaming fix: `large-file-profile/results/release_packaging-after-content-streaming/`
- Final ladder: `large-file-profile/results/release_packaging-final/`
- Serial-vs-parallel diff: `large-file-profile/results/release_packaging-parallel-diff/`
- Malformed large input: `large-file-profile/results/release_packaging-robustness/`
...
Fresh Release Packaging starting profile from the Binding Parity checkpoint:
...
Compared with Binding Surface, common-case memory is dramatically lower. Compared with Binding Parity, the real-file times are within the same sampling-scale envelope; the 703 MB render remains about 631 MB peak, down from 1335 MB in Binding Surface.
...
Large real-file Binding Parity vs Release Packaging text diff:

| File | Bytes Binding Parity | Bytes Release Packaging | SHA-256 Binding Parity | SHA-256 Release Packaging | Result |
|---|---:|---:|---|---|---|
